...
INSERT INTO CURATED.BIKES (bike_id, model_year, make, model, category, condition_level, notes)
...
INSERT INTO CURATED.COMPONENT_CATALOG (catalog_id, make, model, model_year, component_type, component_category, default_specs, notes)
...
INSERT INTO CURATED.BIKE_COMPONENT_INSTANCES (bike_id, catalog_id, is_stock, custom_notes)
VALUES
...
INSERT INTO CURATED.COMPONENT_DOCUMENT_LINK (catalog_id, document_id, link_type)
SELECT 
...
INSERT INTO RAW.DOCUMENT_REGISTRY (source_file, file_path, page_count, file_size_bytes, status)
SELECT 
    '2021_STUMPJUMPER_EVO_USER_MANUAL_ENGLISH.pdf',
    '@RAW.MANUALS_STAGE/2021_STUMPJUMPER_EVO_USER_MANUAL_ENGLISH.pdf',
    33,
    26075887,
    'PROCESSED'
WHERE NOT EXISTS (
